...
class OpenposeDetector:
    def __init__(self, model_path = annotator_ckpts_path):
        self.annotator_ckpts_path = model_path
        body_modelpath = os.path.join(self.annotator_ckpts_path, "body_pose_model.pth")
